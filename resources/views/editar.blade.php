        ...
        <div class="card-body">
            ...
            <form action="/editar-user/{{ $usuario->id }} " method="post">
                ...
                <div class="mb-2 m-3">
                    ...
                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" value="{{ $usuario->email }}" aria-describedby="emailHelp">
                </div>
                <div class="mb-2 m-3">
                    <label for="exampleInputPassword1" class="form-label">Password</label>
                    <input type="password" name="senha" class="form-control" value="{{ $usuario->senha }}" id="exampleInputPassword1">
                </div>
